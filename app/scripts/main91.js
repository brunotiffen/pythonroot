...
var resultOne = (data.similartracks.track[1].name + " " + 
  data.similartracks.track[1].artist.name);
    ...
    var resultOneT = data.similartracks.track[1].name;
          console.log(resultOneT);
    var resultOneA = data.similartracks.track[1].artist.name;
...
var resultThreeT = "";
var resultThreeA = ""; 
console.log(resultOneT, resultOneA, resultTwoT, resultTwoA, resultThreeT, resultThreeA);*/




document.getElementById("Result1search").onclick = function() {search1() };
function search1() {
